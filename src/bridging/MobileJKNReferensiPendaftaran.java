                    ...
                    while(rs.next()){
                        try {     
                            ...
                            if(nameNode.path("code").asText().equals("200")){
                                ...
                                Sequel.queryu("update referensi_mobilejkn_bpjs set statuskirim='Sudah' where nobooking='"+tbJnsPerawatan.getValueAt(tbJnsPerawatan.getSelectedRow(),14).toString()+"'");
                            }
