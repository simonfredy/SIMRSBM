...
public final class SatuSehatMapingLaborat extends javax.swing.JDialog {
        ...
        pemeriksaan.addWindowListener(new WindowListener() {
            ...
            public void windowClosed(WindowEvent e) {
                if(pemeriksaan.getTable().getSelectedRow()!= -1){                    
                    ...
                    NamaTindakanLab.setText(pemeriksaan.getTable().getValueAt(pemeriksaan.getTable().getSelectedRow(),3).toString());
                }
    ...
    private void initComponents() {
        ...
        NamaTindakanLab = new widget.TextBox();
        ...
        jLabel13.setText("Tindakan Radiologi :");
        jLabel13.setName("jLabel13"); // NOI18N
        FormInput.add(jLabel13);
        jLabel13.setBounds(0, 10, 110, 23);

        NamaTindakanLab.setEditable(false);
        NamaTindakanLab.setHighlighter(null);
        NamaTindakanLab.setName("NamaTindakanLab"); // NOI18N
        FormInput.add(NamaTindakanLab);
        NamaTindakanLab.setBounds(240, 10, 440, 23);
    ...
    */
    ...
    private widget.TextBox NamaTindakanLab;
