 ...
 * @author dosen
 */
public class MasterTriaseMacamKasusCustom extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public MasterTriaseMacamKasusCustom(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            MasterTriaseMacamKasusCustom dialog = new MasterTriaseMacamKasusCustom(new javax.swing.JFrame(), true);
    ...
    private void tampil() {
        ...
        try{
            ps=koneksi.prepareStatement("select * from master_triase_macam_kasus_custom where master_triase_macam_kasus_custom.kode_kasus like ? or master_triase_macam_kasus_custom.macam_kasus like ? order by master_triase_macam_kasus_custom.kode_kasus");
            try {
