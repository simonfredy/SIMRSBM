...
public final class RMDataCatatanObservasiRanap extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        FormInput.add(BtnGrafikTTV);
        BtnGrafikTTV.setBounds(820, 40, 120, 23);
    ...
    private void BtnGrafikTTVActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnGrafikTTVActionPerformed
        grafiksqlttv kas = new grafiksqlttv("Grafik TTV Pasien " + TPasien.getText(),
                "select DATE_FORMAT(tgl_perawatan , '%d/%m/%Y') as tgl,jam_rawat,replace(suhu,',','.') as suhu,hr,rr,spo2 from catatan_observasi_ranap where no_rawat='" + TNoRw.getText() + "' and suhu <>''", "Suhu", "Heart Rate", "Respirasi", "Spo2");
        kas.setModal(true);
