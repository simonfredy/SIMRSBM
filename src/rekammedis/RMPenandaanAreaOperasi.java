...
public final class RMPenandaanAreaOperasi extends javax.swing.JDialog {
    ...
    private String finger="",urlImage,lokasifile="";
    ...
    public RMPenandaanAreaOperasi(java.awt.Frame parent, boolean modal) {
        ...
        tabMode=new DefaultTableModel(null,new Object[]{
            ...
            "Hubungan","Ruangan","Operasi","Kode Petugas","Nama Petugas","Keterangan"
        }){
    ...
    private void initComponents() {
        ...
        PanelWall.setBounds(40, 160, 809, 700);
        ...
        TglAsuhan.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "28-07-2024 15:45:35" }));
        ...
        BtnEdit2.setBounds(50, 130, 160, 30);

        label15.setText("Ruangan:");
        label15.setName("label15"); // NOI18N
        label15.setPreferredSize(new java.awt.Dimension(70, 23));
        FormInput.add(label15);
        label15.setBounds(0, 100, 70, 23);
        ...
        Ruangan.setBounds(70, 100, 280, 23);

        label16.setText("Keterangan:");
        label16.setName("label16"); // NOI18N
        label16.setPreferredSize(new java.awt.Dimension(70, 23));
        FormInput.add(label16);
        label16.setBounds(920, 260, 70, 23);
        ...
        Operasi.setBounds(460, 100, 270, 23);

        label17.setText("Perawat:");
        label17.setName("label17"); // NOI18N
        label17.setPreferredSize(new java.awt.Dimension(70, 23));
        FormInput.add(label17);
        label17.setBounds(0, 70, 70, 23);
        ...
        KdPetugas.setBounds(70, 70, 90, 23);

        NmPetugas.setEditable(false);
        NmPetugas.setName("NmPetugas"); // NOI18N
        NmPetugas.setPreferredSize(new java.awt.Dimension(207, 23));
        FormInput.add(NmPetugas);
        NmPetugas.setBounds(170, 70, 180, 23);
        ...
        BtnPerawat.setBounds(350, 70, 28, 23);
        ...
        scrollPane1.setBounds(920, 300, 310, 210);

        label18.setText("Jenis Operasi:");
        label18.setName("label18"); // NOI18N
        label18.setPreferredSize(new java.awt.Dimension(70, 23));
        FormInput.add(label18);
        label18.setBounds(380, 100, 70, 23);
    ...
    if(TNoRM.getText().trim().equals("")){
            ...
            if(Sequel.menyimpantf("penandaan_area_operasi","?,?,?,?,?,?,?,?,?","No.Rawat",9,new String[]{
                    TNoRw.getText(),Valid.SetTgl(TglAsuhan.getSelectedItem()+"")+" "+TglAsuhan.getSelectedItem().toString().substring(11,19),KdDokter.getText(),Anamnesis.getSelectedItem().toString(),Hubungan.getText(),
                    Ruangan.getText(),Operasi.getText(),KdPetugas.getText(),Keterangan.getText()
                })==true){
                    emptTeks();
            }
        } 
...
/*        this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
    ...
    private void BtnPerawatActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPerawatActionPerformed
       akses.setform("RMPenandaanAreaOperasi");
        petugas.emptTeks();
        petugas.isCek();
        ...
        try{
            if(TCari.getText().trim().equals("")){
                ps=koneksi.prepareStatement(
                        "select reg_periksa.no_rawat,pasien.no_rkm_medis,pasien.nm_pasien,if(pasien.jk='L','Laki-Laki','Perempuan') as jk,pasien.tgl_lahir,penandaan_area_operasi.tanggal,"+
                        "penandaan_area_operasi.kd_dokter,penandaan_area_operasi.anamnesis,penandaan_area_operasi.hubungan,penandaan_area_operasi.ruangan,penandaan_area_operasi.operasi,"+
                        "dokter.nm_dokter,penandaan_area_operasi.kd_petugas,penandaan_area_operasi.keterangan,petugas.nama "+
                        "from reg_periksa inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "+
                        "inner join penandaan_area_operasi on reg_periksa.no_rawat=penandaan_area_operasi.no_rawat "+
                        "inner join dokter on penandaan_area_operasi.kd_dokter=dokter.kd_dokter inner join petugas on penandaan_area_operasi.kd_petugas=petugas.nip where "+
            ...
            try {
                ...
                while(rs.next()){
                    tabMode.addRow(new String[]{
                        ...
                        rs.getString("anamnesis"),rs.getString("hubungan"),rs.getString("ruangan"),rs.getString("operasi"),rs.getString("kd_petugas"),rs.getString("nama"),rs.getString("keterangan")
                    });
                }
            } catch (Exception e) {
