...
public final class RMPenilaianAwalMedisRanapBedah extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Pengkajian Awal Medis Rawat Inap Bedah ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 50, 50))); // NOI18N
        ...
        TglAsuhan.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "30-09-2024 20:39:37" }));
    ...
    private void MnPenilaianMedisActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnPenilaianMedisActionPerformed
        if(tbObat.getSelectedRow()>-1){
            ...
            Valid.MyReportqry("rptCetakPenilaianAwalMedisRanapBedah.jasper","report","::[ Pengkajian Awal Medis Rawat Inap Bedah ]::",
                "select reg_periksa.no_rawat,pasien.no_rkm_medis,pasien.nm_pasien,if(pasien.jk='L','Laki-Laki','Perempuan') as jk,pasien.tgl_lahir,pengkajian_medis_ranap_bedah.tanggal,"+
                "pengkajian_medis_ranap_bedah.kd_dokter,pengkajian_medis_ranap_bedah.anamnesis,pengkajian_medis_ranap_bedah.hubungan,pengkajian_medis_ranap_bedah.keluhan_utama,"+
                "pengkajian_medis_ranap_bedah.rps,pengkajian_medis_ranap_bedah.rpd,pengkajian_medis_ranap_bedah.rpo,pengkajian_medis_ranap_bedah.alergi,pengkajian_medis_ranap_bedah.kesadaran,"+
                "pengkajian_medis_ranap_bedah.status,pengkajian_medis_ranap_bedah.td,pengkajian_medis_ranap_bedah.nadi,pengkajian_medis_ranap_bedah.suhu,pengkajian_medis_ranap_bedah.rr,"+
                "pengkajian_medis_ranap_bedah.bb,pengkajian_medis_ranap_bedah.nyeri,pengkajian_medis_ranap_bedah.gcs,pengkajian_medis_ranap_bedah.kepala,pengkajian_medis_ranap_bedah.thoraks,"+
                "pengkajian_medis_ranap_bedah.abdomen,pengkajian_medis_ranap_bedah.ekstremitas,pengkajian_medis_ranap_bedah.genetalia,pengkajian_medis_ranap_bedah.columna,"+
                "pengkajian_medis_ranap_bedah.muskulos,pengkajian_medis_ranap_bedah.lainnya,pengkajian_medis_ranap_bedah.ket_lokalis,pengkajian_medis_ranap_bedah.lab,"+
                "pengkajian_medis_ranap_bedah.rad,pengkajian_medis_ranap_bedah.pemeriksaan,pengkajian_medis_ranap_bedah.diagnosis,pengkajian_medis_ranap_bedah.diagnosis2,"+
                "pengkajian_medis_ranap_bedah.permasalahan,pengkajian_medis_ranap_bedah.terapi,pengkajian_medis_ranap_bedah.tindakan,pengkajian_medis_ranap_bedah.edukasi,dokter.nm_dokter "+
                "from reg_periksa inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "+
                "inner join pengkajian_medis_ranap_bedah on reg_periksa.no_rawat=pengkajian_medis_ranap_bedah.no_rawat "+
                "inner join dokter on pengkajian_medis_ranap_bedah.kd_dokter=dokter.kd_dokter "+
                "where pengkajian_medis_ranap_bedah.no_rawat='"+tbObat.getValueAt(tbObat.getSelectedRow(),0).toString()+"'",param);
        }
    ...
    */
        ...
        try{
            if(TCari.getText().trim().equals("")){
                ps=koneksi.prepareStatement(
                        ...
                        "from reg_periksa inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "+
                        "inner join pengkajian_medis_ranap_bedah on reg_periksa.no_rawat=pengkajian_medis_ranap_bedah.no_rawat "+
                        "inner join dokter on pengkajian_medis_ranap_bedah.kd_dokter=dokter.kd_dokter where "+
                        "pengkajian_medis_ranap_bedah.tanggal between ? and ? order by pengkajian_medis_ranap_bedah.tanggal");
            }else{
                ps=koneksi.prepareStatement(
                        "select reg_periksa.no_rawat,pasien.no_rkm_medis,pasien.nm_pasien,if(pasien.jk='L','Laki-Laki','Perempuan') as jk,pasien.tgl_lahir,pengkajian_medis_ranap_bedah.tanggal,"+
                        "pengkajian_medis_ranap_bedah.kd_dokter,pengkajian_medis_ranap_bedah.anamnesis,pengkajian_medis_ranap_bedah.hubungan,pengkajian_medis_ranap_bedah.keluhan_utama,"+
                        ...
                        "inner join pengkajian_medis_ranap_bedah on reg_periksa.no_rawat=pengkajian_medis_ranap_bedah.no_rawat "+
                        "inner join dokter on pengkajian_medis_ranap_bedah.kd_dokter=dokter.kd_dokter where "+
                        "pengkajian_medis_ranap_bedah.tanggal between ? and ? and (reg_periksa.no_rawat like ? or pasien.no_rkm_medis like ? or pasien.nm_pasien like ? or "+
                        "pengkajian_medis_ranap_bedah.kd_dokter like ? or dokter.nm_dokter like ?) order by pengkajian_medis_ranap_bedah.tanggal");
            }
    ...
    private void ganti() {
        if(Sequel.mengedittf("pengkajian_medis_ranap_bedah","no_rawat=?","no_rawat=?,tanggal=?,kd_dokter=?,anamnesis=?,hubungan=?,keluhan_utama=?,rps=?,rpd=?,rpo=?,alergi=?,kesadaran=?,status=?,td=?,nadi=?,suhu=?,rr=?,bb=?,nyeri=?,"+
    ...
    private void simpan() {
        if(Sequel.menyimpantf("pengkajian_medis_ranap_bedah","?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?","No.Rawat",37,new String[]{
                TNoRw.getText(),Valid.SetTgl(TglAsuhan.getSelectedItem()+"")+" "+TglAsuhan.getSelectedItem().toString().substring(11,19),KdDokter.getText(),Anamnesis.getSelectedItem().toString(),Hubungan.getText(),
                KeluhanUtama.getText(),RPS.getText(),RPD.getText(),RPO.getText(),Alergi.getText(),Kesadaran.getSelectedItem().toString(),Status.getText(),TD.getText(),Nadi.getText(),Suhu.getText(),RR.getText(),BB.getText(),Nyeri.getText(),GCS.getText(),
                Kepala.getSelectedItem().toString(),Thoraks.getSelectedItem().toString(),Abdomen.getSelectedItem().toString(),Ekstremitas.getSelectedItem().toString(),Genetalia.getSelectedItem().toString(),Columna.getSelectedItem().toString(),
                Muskulos.getSelectedItem().toString(),Lainnya.getText(),KetLokalis.getText(),Lab.getText(),Rad.getText(),PenunjangLain.getText(),Diagnosis.getText(),Diagnosis2.getText(),Permasalahan.getText(),Terapi.getText(),Tindakan.getText(),
