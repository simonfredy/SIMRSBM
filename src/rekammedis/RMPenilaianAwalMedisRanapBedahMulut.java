...
public final class RMPenilaianAwalMedisRanapBedahMulut extends javax.swing.JDialog {
    ...
    private void MnPenilaianMedisActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnPenilaianMedisActionPerformed
        if(tbObat.getSelectedRow()>-1){
            ...
            Valid.MyReportqry("rptCetakPenilaianAwalMedisRanapBedahMulut.jasper","report","::[ Laporan Penilaian Awal Medis Rawat Jalan Bedah Mulut ]::",
                "select reg_periksa.no_rawat,pasien.no_rkm_medis,pasien.nm_pasien,if(pasien.jk='L','Laki-Laki','Perempuan') as jk,pasien.tgl_lahir,pengkajian_medis_ranap_bedah_mulut.tanggal,"+
                "pengkajian_medis_ranap_bedah_mulut.kd_dokter,pengkajian_medis_ranap_bedah_mulut.anamnesis,pengkajian_medis_ranap_bedah_mulut.hubungan,pengkajian_medis_ranap_bedah_mulut.keluhan_utama,"+
                "pengkajian_medis_ranap_bedah_mulut.rps,pengkajian_medis_ranap_bedah_mulut.rpk,pengkajian_medis_ranap_bedah_mulut.alergi,pengkajian_medis_ranap_bedah_mulut.keadaan,"+
                "pengkajian_medis_ranap_bedah_mulut.kesadaran,pengkajian_medis_ranap_bedah_mulut.nyeri,pengkajian_medis_ranap_bedah_mulut.td,pengkajian_medis_ranap_bedah_mulut.nadi,"+
                "pengkajian_medis_ranap_bedah_mulut.suhu,pengkajian_medis_ranap_bedah_mulut.rr,pengkajian_medis_ranap_bedah_mulut.bb,pengkajian_medis_ranap_bedah_mulut.tb,"+
                "pengkajian_medis_ranap_bedah_mulut.status_nutrisi,pengkajian_medis_ranap_bedah_mulut.kulit,pengkajian_medis_ranap_bedah_mulut.keterangan_kulit,pengkajian_medis_ranap_bedah_mulut.kepala,"+
                "pengkajian_medis_ranap_bedah_mulut.keterangan_kepala,pengkajian_medis_ranap_bedah_mulut.mata,pengkajian_medis_ranap_bedah_mulut.keterangan_mata,pengkajian_medis_ranap_bedah_mulut.leher,"+
                "pengkajian_medis_ranap_bedah_mulut.keterangan_leher,pengkajian_medis_ranap_bedah_mulut.kelenjar,pengkajian_medis_ranap_bedah_mulut.keterangan_kelenjar,pengkajian_medis_ranap_bedah_mulut.dada,"+
                "pengkajian_medis_ranap_bedah_mulut.keterangan_dada,pengkajian_medis_ranap_bedah_mulut.perut,pengkajian_medis_ranap_bedah_mulut.keterangan_perut,pengkajian_medis_ranap_bedah_mulut.ekstremitas,"+
                "pengkajian_medis_ranap_bedah_mulut.keterangan_ekstremitas,pengkajian_medis_ranap_bedah_mulut.wajah,pengkajian_medis_ranap_bedah_mulut.intra,pengkajian_medis_ranap_bedah_mulut.gigigeligi,"+
                "pengkajian_medis_ranap_bedah_mulut.lab,pengkajian_medis_ranap_bedah_mulut.rad,pengkajian_medis_ranap_bedah_mulut.penunjang,pengkajian_medis_ranap_bedah_mulut.diagnosis,"+
                "pengkajian_medis_ranap_bedah_mulut.diagnosis2,pengkajian_medis_ranap_bedah_mulut.permasalahan,pengkajian_medis_ranap_bedah_mulut.terapi,pengkajian_medis_ranap_bedah_mulut.tindakan,"+
                "pengkajian_medis_ranap_bedah_mulut.edukasi,dokter.nm_dokter "+
                "from reg_periksa inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "+
                "inner join pengkajian_medis_ranap_bedah_mulut on reg_periksa.no_rawat=pengkajian_medis_ranap_bedah_mulut.no_rawat "+
                "inner join dokter on pengkajian_medis_ranap_bedah_mulut.kd_dokter=dokter.kd_dokter where pengkajian_medis_ranap_bedah_mulut.no_rawat='"+tbObat.getValueAt(tbObat.getSelectedRow(),0).toString()+"'",param);
        }
    ...
    */
        ...
        try{
            if(TCari.getText().trim().equals("")){
                ps=koneksi.prepareStatement(
                        ...
                        "from reg_periksa inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "+
                        "inner join pengkajian_medis_ranap_bedah_mulut on reg_periksa.no_rawat=pengkajian_medis_ranap_bedah_mulut.no_rawat "+
                        "inner join dokter on pengkajian_medis_ranap_bedah_mulut.kd_dokter=dokter.kd_dokter where "+
                        "pengkajian_medis_ranap_bedah_mulut.tanggal between ? and ? order by pengkajian_medis_ranap_bedah_mulut.tanggal");
            }else{
                ps=koneksi.prepareStatement(
                        "select reg_periksa.no_rawat,pasien.no_rkm_medis,pasien.nm_pasien,if(pasien.jk='L','Laki-Laki','Perempuan') as jk,pasien.tgl_lahir,pengkajian_medis_ranap_bedah_mulut.tanggal,"+
                        "pengkajian_medis_ranap_bedah_mulut.kd_dokter,pengkajian_medis_ranap_bedah_mulut.anamnesis,pengkajian_medis_ranap_bedah_mulut.hubungan,pengkajian_medis_ranap_bedah_mulut.keluhan_utama,"+
                        ...
                        "inner join pengkajian_medis_ranap_bedah_mulut on reg_periksa.no_rawat=pengkajian_medis_ranap_bedah_mulut.no_rawat "+
                        "inner join dokter on pengkajian_medis_ranap_bedah_mulut.kd_dokter=dokter.kd_dokter where "+
                        "pengkajian_medis_ranap_bedah_mulut.tanggal between ? and ? and (reg_periksa.no_rawat like ? or pasien.no_rkm_medis like ? or pasien.nm_pasien like ? or "+
                        "pengkajian_medis_ranap_bedah_mulut.kd_dokter like ? or dokter.nm_dokter like ?) order by pengkajian_medis_ranap_bedah_mulut.tanggal");
            }
    ...
    private void ganti() {
        if(Sequel.mengedittf("pengkajian_medis_ranap_bedah_mulut","no_rawat=?","no_rawat=?,tanggal=?,kd_dokter=?,anamnesis=?,hubungan=?,keluhan_utama=?,rps=?,rpk=?,alergi=?,keadaan=?,kesadaran=?,nyeri=?,td=?,nadi=?,suhu=?,rr=?,bb=?,"+
    ...
    private void simpan() {
        if(Sequel.menyimpantf("pengkajian_medis_ranap_bedah_mulut","?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?","No.Rawat",47,new String[]{
                TNoRw.getText(),Valid.SetTgl(TglAsuhan.getSelectedItem()+"")+" "+TglAsuhan.getSelectedItem().toString().substring(11,19),KdDokter.getText(),Anamnesis.getSelectedItem().toString(),Hubungan.getText(),
                KeluhanUtama.getText(),RPS.getText(),RPK.getText(),Alergi.getText(),Keadaan.getSelectedItem().toString(),Kesadaran.getSelectedItem().toString(),Nyeri.getSelectedItem().toString(),TD.getText(),Nadi.getText(), 
                Suhu.getText(),RR.getText(),BB.getText(),TB.getText(),StatusNutrisi.getText(),Kulit.getSelectedItem().toString(),KeteranganKulit.getText(),Kepala.getSelectedItem().toString(),KeteranganKepala.getText(), 
                Mata.getSelectedItem().toString(),KeteranganMata.getText(),Leher.getSelectedItem().toString(),KeteranganLeher.getText(),Kelenjar.getSelectedItem().toString(),KeteranganKelenjar.getText(),Dada.getSelectedItem().toString(), 
