...
public final class RMPenilaianAwalMedisRanapGeriatri extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        TglAsuhan.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "08-10-2024 08:18:49" }));
    ...
    private void MnPenilaianMedisActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnPenilaianMedisActionPerformed
        if(tbObat.getSelectedRow()>-1){
            ...
            Valid.MyReportqry("rptCetakPenilaianAwalMedisRanapGeriatri.jasper","report","::[ Laporan Pengkajian Awal Medis Rawat Inap Geriatri ]::",
                "select reg_periksa.no_rawat,pasien.no_rkm_medis,pasien.nm_pasien,if(pasien.jk='L','Laki-Laki','Perempuan') as jk,pasien.tgl_lahir,pengkajian_medis_ranap_geriatri.tanggal,"+
                "pengkajian_medis_ranap_geriatri.kd_dokter,dokter.nm_dokter,pengkajian_medis_ranap_geriatri.anamnesis,pengkajian_medis_ranap_geriatri.hubungan,pengkajian_medis_ranap_geriatri.keluhan_utama,"+
                "pengkajian_medis_ranap_geriatri.rps,pengkajian_medis_ranap_geriatri.rpd,pengkajian_medis_ranap_geriatri.rpo,pengkajian_medis_ranap_geriatri.alergi,pengkajian_medis_ranap_geriatri.tulang_belakang,"+
                "pengkajian_medis_ranap_geriatri.td,pengkajian_medis_ranap_geriatri.nadi,pengkajian_medis_ranap_geriatri.suhu,pengkajian_medis_ranap_geriatri.rr,pengkajian_medis_ranap_geriatri.kondisi_umum,"+
                "pengkajian_medis_ranap_geriatri.status_psikologis_gds,pengkajian_medis_ranap_geriatri.kondisi_sosial,pengkajian_medis_ranap_geriatri.status_kognitif_mmse,pengkajian_medis_ranap_geriatri.kepala,"+
                "pengkajian_medis_ranap_geriatri.keterangan_kepala,pengkajian_medis_ranap_geriatri.thoraks,pengkajian_medis_ranap_geriatri.keterangan_thoraks,pengkajian_medis_ranap_geriatri.abdomen,"+
                "pengkajian_medis_ranap_geriatri.keterangan_abdomen,pengkajian_medis_ranap_geriatri.ekstremitas,pengkajian_medis_ranap_geriatri.keterangan_ekstremitas,pengkajian_medis_ranap_geriatri.Integument_kebersihan,"+
                "pengkajian_medis_ranap_geriatri.Integument_warna,pengkajian_medis_ranap_geriatri.Integument_kelembaban,pengkajian_medis_ranap_geriatri.Integument_gangguan_kulit,pengkajian_medis_ranap_geriatri.status_fungsional,"+
                "pengkajian_medis_ranap_geriatri.skrining_jatuh,pengkajian_medis_ranap_geriatri.status_nutrisi,pengkajian_medis_ranap_geriatri.lainnya,pengkajian_medis_ranap_geriatri.lab,pengkajian_medis_ranap_geriatri.rad,"+
                "pengkajian_medis_ranap_geriatri.pemeriksaan,pengkajian_medis_ranap_geriatri.diagnosis,pengkajian_medis_ranap_geriatri.diagnosis2,pengkajian_medis_ranap_geriatri.permasalahan,pengkajian_medis_ranap_geriatri.terapi,"+
                "pengkajian_medis_ranap_geriatri.tindakan,pengkajian_medis_ranap_geriatri.edukasi "+
                "from reg_periksa inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "+
                "inner join pengkajian_medis_ranap_geriatri on reg_periksa.no_rawat=pengkajian_medis_ranap_geriatri.no_rawat "+
                "inner join dokter on pengkajian_medis_ranap_geriatri.kd_dokter=dokter.kd_dokter where pengkajian_medis_ranap_geriatri.no_rawat='"+tbObat.getValueAt(tbObat.getSelectedRow(),0).toString()+"'",param);
        }
        ...
        try{
            if(TCari.getText().trim().equals("")){
                ps=koneksi.prepareStatement(
                        ...
                        "from reg_periksa inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "+
                        "inner join pengkajian_medis_ranap_geriatri on reg_periksa.no_rawat=pengkajian_medis_ranap_geriatri.no_rawat "+
                        "inner join dokter on pengkajian_medis_ranap_geriatri.kd_dokter=dokter.kd_dokter where "+
                        "pengkajian_medis_ranap_geriatri.tanggal between ? and ? order by pengkajian_medis_ranap_geriatri.tanggal");
            }else{
                ps=koneksi.prepareStatement(
                        "select reg_periksa.no_rawat,pasien.no_rkm_medis,pasien.nm_pasien,if(pasien.jk='L','Laki-Laki','Perempuan') as jk,pasien.tgl_lahir,pengkajian_medis_ranap_geriatri.tanggal,"+
                        "pengkajian_medis_ranap_geriatri.kd_dokter,dokter.nm_dokter,pengkajian_medis_ranap_geriatri.anamnesis,pengkajian_medis_ranap_geriatri.hubungan,pengkajian_medis_ranap_geriatri.keluhan_utama,"+
                        ...
                        "inner join pengkajian_medis_ranap_geriatri on reg_periksa.no_rawat=pengkajian_medis_ranap_geriatri.no_rawat "+
                        "inner join dokter on pengkajian_medis_ranap_geriatri.kd_dokter=dokter.kd_dokter where "+
                        "pengkajian_medis_ranap_geriatri.tanggal between ? and ? and (reg_periksa.no_rawat like ? or pasien.no_rkm_medis like ? or pasien.nm_pasien like ? or "+
                        "pengkajian_medis_ranap_geriatri.kd_dokter like ? or dokter.nm_dokter like ?) order by pengkajian_medis_ranap_geriatri.tanggal");
            }
...
//        BtnEdit.setEnabled(akses.getpenilaian_awal_medis_ralan_geriatri());
    ...
    private void ganti() {
        if(Sequel.mengedittf("pengkajian_medis_ranap_geriatri","no_rawat=?","no_rawat=?,tanggal=?,kd_dokter=?,anamnesis=?,hubungan=?,keluhan_utama=?,rps=?,rpd=?,rpo=?,alergi=?,tulang_belakang=?,td=?,nadi=?,suhu=?,rr=?,kondisi_umum=?,"+
    ...
    private void simpan() {
        if(Sequel.menyimpantf("pengkajian_medis_ranap_geriatri","?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?","No.Rawat",44,new String[]{
                TNoRw.getText(),Valid.SetTgl(TglAsuhan.getSelectedItem()+"")+" "+TglAsuhan.getSelectedItem().toString().substring(11,19),KdDokter.getText(),Anamnesis.getSelectedItem().toString(),Hubungan.getText(),
                KeluhanUtama.getText(),RPS.getText(),RPD.getText(),RPO.getText(),Alergi.getText(),PosturTulang.getSelectedItem().toString(),TD.getText(),Nadi.getText(),Suhu.getText(),RR.getText(),KondisiUmum.getText(),
                Psikologis.getSelectedItem().toString(),KondisiSosial.getText(),Kognitif.getSelectedItem().toString(),Kepala.getSelectedItem().toString(),KeteranganKepala.getText(),Thoraks.getSelectedItem().toString(),
                KeteranganThoraks.getText(),Abdomen.getSelectedItem().toString(),KeteranganAbdomen.getText(),Ekstremitas.getSelectedItem().toString(),KeteranganEkstremitas.getText(),IntegumentKebersihan.getSelectedItem().toString(),
