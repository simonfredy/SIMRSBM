...
public final class RMPenilaianAwalMedisRanapKulitDanKelamin extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Pengkajian Awal Medis Rawat Inap Kulit & Kelamin ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 50, 50))); // NOI18N
        ...
        TglAsuhan.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "02-10-2024 06:17:12" }));
    ...
    private void MnPenilaianMedisActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnPenilaianMedisActionPerformed
        if(tbObat.getSelectedRow()>-1){
            ...
            Valid.MyReportqry("rptCetakPenilaianAwalMedisRanapKulitKelamin.jasper","report","::[ Laporan Penilaian Awal Medis Rawat Jalan Kulit & Kelamin ]::",
                "select reg_periksa.no_rawat,pasien.no_rkm_medis,pasien.nm_pasien,if(pasien.jk='L','Laki-Laki','Perempuan') as jk,pasien.tgl_lahir,pengkajian_medis_ranap_kulitdankelamin.tanggal,"+
                "pengkajian_medis_ranap_kulitdankelamin.kd_dokter,pengkajian_medis_ranap_kulitdankelamin.anamnesis,pengkajian_medis_ranap_kulitdankelamin.hubungan,pengkajian_medis_ranap_kulitdankelamin.keluhan_utama,pengkajian_medis_ranap_kulitdankelamin.rps,pengkajian_medis_ranap_kulitdankelamin.rpd,pengkajian_medis_ranap_kulitdankelamin.rpo,pengkajian_medis_ranap_kulitdankelamin.rpk,"+
                "pengkajian_medis_ranap_kulitdankelamin.kesadaran,pengkajian_medis_ranap_kulitdankelamin.status,pengkajian_medis_ranap_kulitdankelamin.td,pengkajian_medis_ranap_kulitdankelamin.nadi,pengkajian_medis_ranap_kulitdankelamin.suhu,pengkajian_medis_ranap_kulitdankelamin.rr,pengkajian_medis_ranap_kulitdankelamin.bb,pengkajian_medis_ranap_kulitdankelamin.nyeri,pengkajian_medis_ranap_kulitdankelamin.gcs,"+
                "pengkajian_medis_ranap_kulitdankelamin.statusderma,pengkajian_medis_ranap_kulitdankelamin.pemeriksaan,pengkajian_medis_ranap_kulitdankelamin.diagnosis,pengkajian_medis_ranap_kulitdankelamin.diagnosis2,pengkajian_medis_ranap_kulitdankelamin.permasalahan,pengkajian_medis_ranap_kulitdankelamin.terapi,pengkajian_medis_ranap_kulitdankelamin.tindakan,pengkajian_medis_ranap_kulitdankelamin.edukasi,dokter.nm_dokter "+
                "from reg_periksa inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "+
                "inner join pengkajian_medis_ranap_kulitdankelamin on reg_periksa.no_rawat=pengkajian_medis_ranap_kulitdankelamin.no_rawat "+
                "inner join dokter on pengkajian_medis_ranap_kulitdankelamin.kd_dokter=dokter.kd_dokter "+
                "where pengkajian_medis_ranap_kulitdankelamin.no_rawat='"+tbObat.getValueAt(tbObat.getSelectedRow(),0).toString()+"'",param);
        }
        ...
        try{
            if(TCari.getText().trim().equals("")){
                ps=koneksi.prepareStatement(
                        ...
                        "from reg_periksa inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "+
                        "inner join pengkajian_medis_ranap_kulitdankelamin on reg_periksa.no_rawat=pengkajian_medis_ranap_kulitdankelamin.no_rawat "+
                        "inner join dokter on pengkajian_medis_ranap_kulitdankelamin.kd_dokter=dokter.kd_dokter where "+
                        "pengkajian_medis_ranap_kulitdankelamin.tanggal between ? and ? order by pengkajian_medis_ranap_kulitdankelamin.tanggal");
            }else{
                ps=koneksi.prepareStatement(
                        "select reg_periksa.no_rawat,pasien.no_rkm_medis,pasien.nm_pasien,if(pasien.jk='L','Laki-Laki','Perempuan') as jk,pasien.tgl_lahir,pengkajian_medis_ranap_kulitdankelamin.tanggal,"+
                        "pengkajian_medis_ranap_kulitdankelamin.kd_dokter,pengkajian_medis_ranap_kulitdankelamin.anamnesis,pengkajian_medis_ranap_kulitdankelamin.hubungan,pengkajian_medis_ranap_kulitdankelamin.keluhan_utama,pengkajian_medis_ranap_kulitdankelamin.rps,pengkajian_medis_ranap_kulitdankelamin.rpd,pengkajian_medis_ranap_kulitdankelamin.rpo,pengkajian_medis_ranap_kulitdankelamin.rpk,"+
                        ...
                        "inner join pengkajian_medis_ranap_kulitdankelamin on reg_periksa.no_rawat=pengkajian_medis_ranap_kulitdankelamin.no_rawat "+
                        "inner join dokter on pengkajian_medis_ranap_kulitdankelamin.kd_dokter=dokter.kd_dokter where "+
                        "pengkajian_medis_ranap_kulitdankelamin.tanggal between ? and ? and (reg_periksa.no_rawat like ? or pasien.no_rkm_medis like ? or pasien.nm_pasien like ? or "+
                        "pengkajian_medis_ranap_kulitdankelamin.kd_dokter like ? or dokter.nm_dokter like ?) order by pengkajian_medis_ranap_kulitdankelamin.tanggal");
            }
...
//        BtnEdit.setEnabled(akses.getpenilaian_awal_medis_ralan_kulit_kelamin());
    ...
    private void ganti() {
        if(Sequel.mengedittf("pengkajian_medis_ranap_kulitdankelamin","no_rawat=?","no_rawat=?,tanggal=?,kd_dokter=?,anamnesis=?,hubungan=?,keluhan_utama=?,rps=?,rpd=?,rpo=?,rpk=?,kesadaran=?,status=?,td=?,nadi=?,suhu=?,rr=?,bb=?,nyeri=?,gcs=?,statusderma=?,pemeriksaan=?,diagnosis=?,diagnosis2=?,permasalahan=?,terapi=?,tindakan=?,edukasi=?",28,new String[]{
    ...
    private void simpan() {
        if(Sequel.menyimpantf("pengkajian_medis_ranap_kulitdankelamin","?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?","No.Rawat",27,new String[]{
