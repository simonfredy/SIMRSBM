...
public final class RMPenilaianAwalMedisRanapMata extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Pengkajian Awal Medis Rawat Inap Mata ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 50, 50))); // NOI18N
        ...
        TglAsuhan.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "01-10-2024 21:21:12" }));
    ...
    private void MnPenilaianMedisActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnPenilaianMedisActionPerformed
        if(tbObat.getSelectedRow()>-1){
            ...
            Valid.MyReportqry("rptCetakPenilaianAwalMedisRanapMata.jasper","report","::[ Laporan Penilaian Awal Medis Rawat Jalan Mata ]::",
                "select reg_periksa.no_rawat,pasien.no_rkm_medis,pasien.nm_pasien,if(pasien.jk='L','Laki-Laki','Perempuan') as jk,pasien.tgl_lahir,pengkajian_medis_ranap_mata.tanggal,"+
                "pengkajian_medis_ranap_mata.kd_dokter,pengkajian_medis_ranap_mata.anamnesis,pengkajian_medis_ranap_mata.hubungan,pengkajian_medis_ranap_mata.keluhan_utama,pengkajian_medis_ranap_mata.rps,pengkajian_medis_ranap_mata.rpd,pengkajian_medis_ranap_mata.rpo,pengkajian_medis_ranap_mata.alergi,"+
                "pengkajian_medis_ranap_mata.status,pengkajian_medis_ranap_mata.td,pengkajian_medis_ranap_mata.nadi,pengkajian_medis_ranap_mata.rr,pengkajian_medis_ranap_mata.suhu,pengkajian_medis_ranap_mata.nyeri,pengkajian_medis_ranap_mata.bb,"+
                "pengkajian_medis_ranap_mata.visuskanan,pengkajian_medis_ranap_mata.visuskiri,pengkajian_medis_ranap_mata.cckanan,pengkajian_medis_ranap_mata.cckiri,pengkajian_medis_ranap_mata.palkanan,pengkajian_medis_ranap_mata.palkiri,pengkajian_medis_ranap_mata.conkanan,pengkajian_medis_ranap_mata.conkiri,"+
                "pengkajian_medis_ranap_mata.corneakanan,pengkajian_medis_ranap_mata.corneakiri,pengkajian_medis_ranap_mata.coakanan,pengkajian_medis_ranap_mata.coakiri,pengkajian_medis_ranap_mata.pupilkanan,pengkajian_medis_ranap_mata.pupilkiri,pengkajian_medis_ranap_mata.lensakanan,pengkajian_medis_ranap_mata.lensakiri,"+
                "pengkajian_medis_ranap_mata.funduskanan,pengkajian_medis_ranap_mata.funduskiri,pengkajian_medis_ranap_mata.papilkanan,pengkajian_medis_ranap_mata.papilkiri,pengkajian_medis_ranap_mata.retinakanan,pengkajian_medis_ranap_mata.retinakiri,pengkajian_medis_ranap_mata.makulakanan,pengkajian_medis_ranap_mata.makulakiri,"+
                "pengkajian_medis_ranap_mata.tiokanan,pengkajian_medis_ranap_mata.tiokiri,pengkajian_medis_ranap_mata.mbokanan,pengkajian_medis_ranap_mata.mbokiri,pengkajian_medis_ranap_mata.lab,pengkajian_medis_ranap_mata.rad,pengkajian_medis_ranap_mata.penunjang,pengkajian_medis_ranap_mata.tes,pengkajian_medis_ranap_mata.pemeriksaan,"+
                "pengkajian_medis_ranap_mata.diagnosis,pengkajian_medis_ranap_mata.diagnosisbdg,pengkajian_medis_ranap_mata.permasalahan,pengkajian_medis_ranap_mata.terapi,pengkajian_medis_ranap_mata.tindakan,pengkajian_medis_ranap_mata.edukasi,dokter.nm_dokter "+
                "from reg_periksa inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "+
                "inner join pengkajian_medis_ranap_mata on reg_periksa.no_rawat=pengkajian_medis_ranap_mata.no_rawat "+
                "inner join dokter on pengkajian_medis_ranap_mata.kd_dokter=dokter.kd_dokter where pengkajian_medis_ranap_mata.no_rawat='"+tbObat.getValueAt(tbObat.getSelectedRow(),0).toString()+"'",param);
        }
        ...
        try{
            if(TCari.getText().trim().equals("")){
                ps=koneksi.prepareStatement(
                        ...
                        "from reg_periksa inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "+
                        "inner join pengkajian_medis_ranap_mata on reg_periksa.no_rawat=pengkajian_medis_ranap_mata.no_rawat "+
                        "inner join dokter on pengkajian_medis_ranap_mata.kd_dokter=dokter.kd_dokter where "+
                        "pengkajian_medis_ranap_mata.tanggal between ? and ? order by pengkajian_medis_ranap_mata.tanggal");
            }else{
                ps=koneksi.prepareStatement(
                        "select reg_periksa.no_rawat,pasien.no_rkm_medis,pasien.nm_pasien,if(pasien.jk='L','Laki-Laki','Perempuan') as jk,pasien.tgl_lahir,pengkajian_medis_ranap_mata.tanggal,"+
                        "pengkajian_medis_ranap_mata.kd_dokter,pengkajian_medis_ranap_mata.anamnesis,pengkajian_medis_ranap_mata.hubungan,pengkajian_medis_ranap_mata.keluhan_utama,pengkajian_medis_ranap_mata.rps,pengkajian_medis_ranap_mata.rpd,pengkajian_medis_ranap_mata.rpo,pengkajian_medis_ranap_mata.alergi,"+
                        ...
                        "inner join pengkajian_medis_ranap_mata on reg_periksa.no_rawat=pengkajian_medis_ranap_mata.no_rawat "+
                        "inner join dokter on pengkajian_medis_ranap_mata.kd_dokter=dokter.kd_dokter where "+
                        "pengkajian_medis_ranap_mata.tanggal between ? and ? and (reg_periksa.no_rawat like ? or pasien.no_rkm_medis like ? or pasien.nm_pasien like ? or "+
                        "pengkajian_medis_ranap_mata.kd_dokter like ? or dokter.nm_dokter like ?) order by pengkajian_medis_ranap_mata.tanggal");
            }
...
//        BtnEdit.setEnabled(akses.getpenilaian_awal_medis_ralan_mata());
    ...
    private void ganti() {
        if(Sequel.mengedittf("pengkajian_medis_ranap_mata","no_rawat=?","no_rawat=?,tanggal=?,kd_dokter=?,anamnesis=?,hubungan=?,keluhan_utama=?,rps=?,rpd=?,rpo=?,alergi=?,status=?,td=?,nadi=?,rr=?,suhu=?,"+
    ...
    private void simpan() {
        if(Sequel.menyimpantf("pengkajian_medis_ranap_mata","?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?","No.Rawat",56,new String[]{
                TNoRw.getText(),Valid.SetTgl(TglAsuhan.getSelectedItem()+"")+" "+TglAsuhan.getSelectedItem().toString().substring(11,19),KdDokter.getText(),Anamnesis.getSelectedItem().toString(),Hubungan.getText(),
                KeluhanUtama.getText(),RPS.getText(),RPD.getText(),RPO.getText(),Alergi.getText(),StatusNutrisi.getText(),TD.getText(),Nadi.getText(),RR.getText(),Suhu.getText(),Nyeri.getText(),BB.getText(),
                Visuskanan.getText(),Visuskiri.getText(),CCkanan.getText(),CCkiri.getText(),Palkanan.getText(),Palkiri.getText(),Conkanan.getText(),Conkiri.getText(),Corneakanan.getText(),Corneakiri.getText(),COAkanan.getText(),COAkiri.getText(),Pupilkanan.getText(),Pupilkiri.getText(),
                Lensakanan.getText(),Lensakiri.getText(),Funduskanan.getText(),Funduskiri.getText(),Papilkanan.getText(),Papilkiri.getText(),Retinakanan.getText(),Retinakiri.getText(),Makulakanan.getText(),Makulakiri.getText(),TIOkanan.getText(),TIOkiri.getText(),MBOkanan.getText(),MBOkiri.getText(),
