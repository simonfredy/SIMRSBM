...
public final class RMPenilaianAwalMedisRanapNeurologi extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Pengkajian Awal Medis Rawat Inap Saraf ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 50, 50))); // NOI18N
        ...
        TglAsuhan.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "01-10-2024 21:50:01" }));
            ...
            try{
                if(TCari.getText().trim().equals("")){
                    ps=koneksi.prepareStatement(
                        "select reg_periksa.no_rawat,pasien.no_rkm_medis,pasien.nm_pasien,if(pasien.jk='L','Laki-Laki','Perempuan') as jk,pasien.tgl_lahir,pengkajian_medis_ranap_neurologi.tanggal,"+
                        "pengkajian_medis_ranap_neurologi.kd_dokter,pengkajian_medis_ranap_neurologi.anamnesis,pengkajian_medis_ranap_neurologi.hubungan,pengkajian_medis_ranap_neurologi.keluhan_utama,"+
                        "pengkajian_medis_ranap_neurologi.rps,pengkajian_medis_ranap_neurologi.rpd,pengkajian_medis_ranap_neurologi.rpo,pengkajian_medis_ranap_neurologi.alergi,pengkajian_medis_ranap_neurologi.kesadaran,"+
                        "pengkajian_medis_ranap_neurologi.status,pengkajian_medis_ranap_neurologi.td,pengkajian_medis_ranap_neurologi.nadi,pengkajian_medis_ranap_neurologi.suhu,pengkajian_medis_ranap_neurologi.rr,"+
                        "pengkajian_medis_ranap_neurologi.bb,pengkajian_medis_ranap_neurologi.nyeri,pengkajian_medis_ranap_neurologi.gcs,pengkajian_medis_ranap_neurologi.kepala,pengkajian_medis_ranap_neurologi.keterangan_kepala,"+
                        "pengkajian_medis_ranap_neurologi.thoraks,pengkajian_medis_ranap_neurologi.keterangan_thoraks,pengkajian_medis_ranap_neurologi.abdomen,pengkajian_medis_ranap_neurologi.keterangan_abdomen,"+
                        "pengkajian_medis_ranap_neurologi.ekstremitas,pengkajian_medis_ranap_neurologi.keterangan_ekstremitas,pengkajian_medis_ranap_neurologi.columna,pengkajian_medis_ranap_neurologi.keterangan_columna,"+
                        "pengkajian_medis_ranap_neurologi.muskulos,pengkajian_medis_ranap_neurologi.keterangan_muskulos,pengkajian_medis_ranap_neurologi.lainnya,pengkajian_medis_ranap_neurologi.lab,"+
                        "pengkajian_medis_ranap_neurologi.rad,pengkajian_medis_ranap_neurologi.penunjanglain,pengkajian_medis_ranap_neurologi.diagnosis,pengkajian_medis_ranap_neurologi.diagnosis2,"+
                        "pengkajian_medis_ranap_neurologi.permasalahan,pengkajian_medis_ranap_neurologi.terapi,pengkajian_medis_ranap_neurologi.tindakan,pengkajian_medis_ranap_neurologi.edukasi,dokter.nm_dokter "+
                        "from reg_periksa inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "+
                        "inner join pengkajian_medis_ranap_neurologi on reg_periksa.no_rawat=pengkajian_medis_ranap_neurologi.no_rawat "+
                        "inner join dokter on pengkajian_medis_ranap_neurologi.kd_dokter=dokter.kd_dokter where "+
                        "pengkajian_medis_ranap_neurologi.tanggal between ? and ? order by pengkajian_medis_ranap_neurologi.tanggal");
                }else{
                    ps=koneksi.prepareStatement(
                        "select reg_periksa.no_rawat,pasien.no_rkm_medis,pasien.nm_pasien,if(pasien.jk='L','Laki-Laki','Perempuan') as jk,pasien.tgl_lahir,pengkajian_medis_ranap_neurologi.tanggal,"+
                        "pengkajian_medis_ranap_neurologi.kd_dokter,pengkajian_medis_ranap_neurologi.anamnesis,pengkajian_medis_ranap_neurologi.hubungan,pengkajian_medis_ranap_neurologi.keluhan_utama,"+
                        ...
                        "inner join pengkajian_medis_ranap_neurologi on reg_periksa.no_rawat=pengkajian_medis_ranap_neurologi.no_rawat "+
                        "inner join dokter on pengkajian_medis_ranap_neurologi.kd_dokter=dokter.kd_dokter where "+
                        "pengkajian_medis_ranap_neurologi.tanggal between ? and ? and (reg_periksa.no_rawat like ? or pasien.no_rkm_medis like ? or pasien.nm_pasien like ? or "+
                        "pengkajian_medis_ranap_neurologi.kd_dokter like ? or dokter.nm_dokter like ?) order by pengkajian_medis_ranap_neurologi.tanggal");
                }
    ...
    private void MnPenilaianMedisActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnPenilaianMedisActionPerformed
        if(tbObat.getSelectedRow()>-1){
            ...
            Valid.MyReportqry("rptCetakPenilaianAwalMedisRanapNeurologi.jasper","report","::[ Laporan Penilaian Awal Medis Rawat Jalan Neurologi ]::",
                "select reg_periksa.no_rawat,pasien.no_rkm_medis,pasien.nm_pasien,if(pasien.jk='L','Laki-Laki','Perempuan') as jk,pasien.tgl_lahir,pengkajian_medis_ranap_neurologi.tanggal,"+
                "pengkajian_medis_ranap_neurologi.kd_dokter,pengkajian_medis_ranap_neurologi.anamnesis,pengkajian_medis_ranap_neurologi.hubungan,pengkajian_medis_ranap_neurologi.keluhan_utama,"+
                "pengkajian_medis_ranap_neurologi.rps,pengkajian_medis_ranap_neurologi.rpd,pengkajian_medis_ranap_neurologi.rpo,pengkajian_medis_ranap_neurologi.alergi,pengkajian_medis_ranap_neurologi.kesadaran,"+
                "pengkajian_medis_ranap_neurologi.status,pengkajian_medis_ranap_neurologi.td,pengkajian_medis_ranap_neurologi.nadi,pengkajian_medis_ranap_neurologi.suhu,pengkajian_medis_ranap_neurologi.rr,"+
                ...
                "from reg_periksa inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "+
                "inner join pengkajian_medis_ranap_neurologi on reg_periksa.no_rawat=pengkajian_medis_ranap_neurologi.no_rawat "+
                "inner join dokter on pengkajian_medis_ranap_neurologi.kd_dokter=dokter.kd_dokter where pengkajian_medis_ranap_neurologi.no_rawat='"+tbObat.getValueAt(tbObat.getSelectedRow(),0).toString()+"'",param);
        }
...
//        BtnEdit.setEnabled(akses.getpenilaian_awal_medis_ralan_neurologi());
    ...
    private void ganti() {
        if(Sequel.mengedittf("pengkajian_medis_ranap_neurologi","no_rawat=?","no_rawat=?,tanggal=?,kd_dokter=?,anamnesis=?,hubungan=?,keluhan_utama=?,rps=?,rpd=?,rpo=?,alergi=?,kesadaran=?,status=?,td=?,nadi=?,suhu=?,rr=?,bb=?,nyeri=?,gcs=?,"+
    ...
    private void simpan() {
        if(Sequel.menyimpantf("pengkajian_medis_ranap_neurologi","?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?","No.Rawat",41,new String[]{
                TNoRw.getText(),Valid.SetTgl(TglAsuhan.getSelectedItem()+"")+" "+TglAsuhan.getSelectedItem().toString().substring(11,19),KdDokter.getText(),Anamnesis.getSelectedItem().toString(),Hubungan.getText(),
                KeluhanUtama.getText(),RPS.getText(),RPD.getText(),RPO.getText(),Alergi.getText(),Kesadaran.getSelectedItem().toString(),Status.getSelectedItem().toString(),TD.getText(),Nadi.getText(),Suhu.getText(),RR.getText(),BB.getText(),Nyeri.getText(),GCS.getText(),
                Kepala.getSelectedItem().toString(),KeteranganKepala.getText(),Thoraks.getSelectedItem().toString(),KeteranganThoraks.getText(),Abdomen.getSelectedItem().toString(),KeteranganAbdomen.getText(),Ekstremitas.getSelectedItem().toString(),KeteranganEkstremitas.getText(),
                Columna.getSelectedItem().toString(),KeteranganColumna.getText(),Muskulos.getSelectedItem().toString(),KeteranganMusku.getText(),Lainnya.getText(),Lab.getText(),Rad.getText(),PenunjangLain.getText(),Diagnosis.getText(),Diagnosis2.getText(),Permasalahan.getText(),
