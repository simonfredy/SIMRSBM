...
public final class RMPenilaianAwalMedisRanapOrthopedi extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Pengkajian Awal Medis Rawat Inap Orthopedi ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 50, 50))); // NOI18N
        ...
        TglAsuhan.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "01-10-2024 22:08:56" }));
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(TNoRM.getText().trim().equals("")){
            ...
            if(Sequel.menyimpantf("pengkajian_medis_ranap_orthopedi","?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?","No.Rawat",37,new String[]{
            ...
            try{
                if(TCari.getText().trim().equals("")){
                    ps=koneksi.prepareStatement(
                        "select reg_periksa.no_rawat,pasien.no_rkm_medis,pasien.nm_pasien,if(pasien.jk='L','Laki-Laki','Perempuan') as jk,pasien.tgl_lahir,pengkajian_medis_ranap_orthopedi.tanggal,"+
                        "pengkajian_medis_ranap_orthopedi.kd_dokter,pengkajian_medis_ranap_orthopedi.anamnesis,pengkajian_medis_ranap_orthopedi.hubungan,pengkajian_medis_ranap_orthopedi.keluhan_utama,"+
                        "pengkajian_medis_ranap_orthopedi.rps,pengkajian_medis_ranap_orthopedi.rpd,pengkajian_medis_ranap_orthopedi.rpo,pengkajian_medis_ranap_orthopedi.alergi,pengkajian_medis_ranap_orthopedi.kesadaran,"+
                        "pengkajian_medis_ranap_orthopedi.status,pengkajian_medis_ranap_orthopedi.td,pengkajian_medis_ranap_orthopedi.nadi,pengkajian_medis_ranap_orthopedi.suhu,pengkajian_medis_ranap_orthopedi.rr,"+
                        "pengkajian_medis_ranap_orthopedi.bb,pengkajian_medis_ranap_orthopedi.nyeri,pengkajian_medis_ranap_orthopedi.gcs,pengkajian_medis_ranap_orthopedi.kepala,pengkajian_medis_ranap_orthopedi.thoraks,"+
                        "pengkajian_medis_ranap_orthopedi.abdomen,pengkajian_medis_ranap_orthopedi.ekstremitas,pengkajian_medis_ranap_orthopedi.genetalia,pengkajian_medis_ranap_orthopedi.columna,"+
                        "pengkajian_medis_ranap_orthopedi.muskulos,pengkajian_medis_ranap_orthopedi.lainnya,pengkajian_medis_ranap_orthopedi.ket_lokalis,pengkajian_medis_ranap_orthopedi.lab,"+
                        "pengkajian_medis_ranap_orthopedi.rad,pengkajian_medis_ranap_orthopedi.pemeriksaan,pengkajian_medis_ranap_orthopedi.diagnosis,pengkajian_medis_ranap_orthopedi.diagnosis2,"+
                        "pengkajian_medis_ranap_orthopedi.permasalahan,pengkajian_medis_ranap_orthopedi.terapi,pengkajian_medis_ranap_orthopedi.tindakan,pengkajian_medis_ranap_orthopedi.edukasi,dokter.nm_dokter "+
                        "from reg_periksa inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "+
                        "inner join pengkajian_medis_ranap_orthopedi on reg_periksa.no_rawat=pengkajian_medis_ranap_orthopedi.no_rawat "+
                        "inner join dokter on pengkajian_medis_ranap_orthopedi.kd_dokter=dokter.kd_dokter where "+
                        "pengkajian_medis_ranap_orthopedi.tanggal between ? and ? order by pengkajian_medis_ranap_orthopedi.tanggal");
                }else{
                    ps=koneksi.prepareStatement(
                        "select reg_periksa.no_rawat,pasien.no_rkm_medis,pasien.nm_pasien,if(pasien.jk='L','Laki-Laki','Perempuan') as jk,pasien.tgl_lahir,pengkajian_medis_ranap_orthopedi.tanggal,"+
                        "pengkajian_medis_ranap_orthopedi.kd_dokter,pengkajian_medis_ranap_orthopedi.anamnesis,pengkajian_medis_ranap_orthopedi.hubungan,pengkajian_medis_ranap_orthopedi.keluhan_utama,"+
                        ...
                        "inner join pengkajian_medis_ranap_orthopedi on reg_periksa.no_rawat=pengkajian_medis_ranap_orthopedi.no_rawat "+
                        "inner join dokter on pengkajian_medis_ranap_orthopedi.kd_dokter=dokter.kd_dokter where "+
                        "pengkajian_medis_ranap_orthopedi.tanggal between ? and ? and (reg_periksa.no_rawat like ? or pasien.no_rkm_medis like ? or pasien.nm_pasien like ? or "+
                        "pengkajian_medis_ranap_orthopedi.kd_dokter like ? or dokter.nm_dokter like ?) order by pengkajian_medis_ranap_orthopedi.tanggal");
                }
    ...
    private void MnPenilaianMedisActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnPenilaianMedisActionPerformed
        if(tbObat.getSelectedRow()>-1){
            ...
            Valid.MyReportqry("rptCetakPenilaianAwalMedisRanapOrthopedi.jasper","report","::[ Laporan Penilaian Awal Medis Rawat Jalan Orthopedi ]::",
                "select reg_periksa.no_rawat,pasien.no_rkm_medis,pasien.nm_pasien,if(pasien.jk='L','Laki-Laki','Perempuan') as jk,pasien.tgl_lahir,pengkajian_medis_ranap_orthopedi.tanggal,"+
                "pengkajian_medis_ranap_orthopedi.kd_dokter,pengkajian_medis_ranap_orthopedi.anamnesis,pengkajian_medis_ranap_orthopedi.hubungan,pengkajian_medis_ranap_orthopedi.keluhan_utama,"+
                "pengkajian_medis_ranap_orthopedi.rps,pengkajian_medis_ranap_orthopedi.rpd,pengkajian_medis_ranap_orthopedi.rpo,pengkajian_medis_ranap_orthopedi.alergi,pengkajian_medis_ranap_orthopedi.kesadaran,"+
                "pengkajian_medis_ranap_orthopedi.status,pengkajian_medis_ranap_orthopedi.td,pengkajian_medis_ranap_orthopedi.nadi,pengkajian_medis_ranap_orthopedi.suhu,pengkajian_medis_ranap_orthopedi.rr,"+
                ...
                "from reg_periksa inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "+
                "inner join pengkajian_medis_ranap_orthopedi on reg_periksa.no_rawat=pengkajian_medis_ranap_orthopedi.no_rawat "+
                "inner join dokter on pengkajian_medis_ranap_orthopedi.kd_dokter=dokter.kd_dokter "+
                "where pengkajian_medis_ranap_orthopedi.no_rawat='"+tbObat.getValueAt(tbObat.getSelectedRow(),0).toString()+"'",param);
        }
    ...
    */
    ...
    private void ganti() {
        if(Sequel.mengedittf("pengkajian_medis_ranap_orthopedi","no_rawat=?","no_rawat=?,tanggal=?,kd_dokter=?,anamnesis=?,hubungan=?,keluhan_utama=?,rps=?,rpd=?,rpo=?,alergi=?,kesadaran=?,status=?,td=?,nadi=?,suhu=?,rr=?,bb=?,nyeri=?,"+
