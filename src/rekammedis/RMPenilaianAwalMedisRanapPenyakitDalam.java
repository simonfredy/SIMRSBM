...
public final class RMPenilaianAwalMedisRanapPenyakitDalam extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Pengkajian Awal Medis Rawat Inap Penyakit Dalam ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 50, 50))); // NOI18N
        ...
        TglAsuhan.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "30-09-2024 12:53:49" }));
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(TNoRM.getText().trim().equals("")){
            ...
            if(Sequel.menyimpantf("pengkajian_medis_ranap_penyakit_dalam","?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?","No.Rawat",37,new String[]{
    ...
    private void MnPenilaianMedisActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnPenilaianMedisActionPerformed
        if(tbObat.getSelectedRow()>-1){
            ...
            Valid.MyReportqry("rptCetakPenilaianAwalMedisRanapPenyakitDalam.jasper","report","::[ Pengkajian Awal Medis Rawat Inap Penyakit Dalam ]::",
                "select reg_periksa.no_rawat,pasien.no_rkm_medis,pasien.nm_pasien,if(pasien.jk='L','Laki-Laki','Perempuan') as jk,pasien.tgl_lahir,pengkajian_medis_ranap_penyakit_dalam.tanggal,"+
                "pengkajian_medis_ranap_penyakit_dalam.kd_dokter,pengkajian_medis_ranap_penyakit_dalam.anamnesis,pengkajian_medis_ranap_penyakit_dalam.hubungan,pengkajian_medis_ranap_penyakit_dalam.keluhan_utama,"+
                "pengkajian_medis_ranap_penyakit_dalam.rps,pengkajian_medis_ranap_penyakit_dalam.rpd,pengkajian_medis_ranap_penyakit_dalam.rpo,pengkajian_medis_ranap_penyakit_dalam.alergi,"+
                "pengkajian_medis_ranap_penyakit_dalam.kondisi,pengkajian_medis_ranap_penyakit_dalam.status,pengkajian_medis_ranap_penyakit_dalam.td,pengkajian_medis_ranap_penyakit_dalam.nadi,"+
                "pengkajian_medis_ranap_penyakit_dalam.suhu,pengkajian_medis_ranap_penyakit_dalam.rr,pengkajian_medis_ranap_penyakit_dalam.bb,pengkajian_medis_ranap_penyakit_dalam.nyeri,pengkajian_medis_ranap_penyakit_dalam.gcs,"+
                "pengkajian_medis_ranap_penyakit_dalam.kepala,pengkajian_medis_ranap_penyakit_dalam.thoraks,pengkajian_medis_ranap_penyakit_dalam.abdomen,pengkajian_medis_ranap_penyakit_dalam.ekstremitas,"+
                "pengkajian_medis_ranap_penyakit_dalam.lainnya,pengkajian_medis_ranap_penyakit_dalam.lab,pengkajian_medis_ranap_penyakit_dalam.rad,pengkajian_medis_ranap_penyakit_dalam.penunjanglain,"+
                "pengkajian_medis_ranap_penyakit_dalam.diagnosis,pengkajian_medis_ranap_penyakit_dalam.diagnosis2,pengkajian_medis_ranap_penyakit_dalam.permasalahan,pengkajian_medis_ranap_penyakit_dalam.terapi,"+
                "pengkajian_medis_ranap_penyakit_dalam.tindakan,pengkajian_medis_ranap_penyakit_dalam.edukasi,dokter.nm_dokter,pengkajian_medis_ranap_penyakit_dalam.keterangan_kepala,pengkajian_medis_ranap_penyakit_dalam.keterangan_thorak,"+
                "pengkajian_medis_ranap_penyakit_dalam.keterangan_abdomen,pengkajian_medis_ranap_penyakit_dalam.keterangan_ekstremitas "+
                "from reg_periksa inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "+
                "inner join pengkajian_medis_ranap_penyakit_dalam on reg_periksa.no_rawat=pengkajian_medis_ranap_penyakit_dalam.no_rawat "+
                "inner join dokter on pengkajian_medis_ranap_penyakit_dalam.kd_dokter=dokter.kd_dokter where pengkajian_medis_ranap_penyakit_dalam.no_rawat='"+tbObat.getValueAt(tbObat.getSelectedRow(),0).toString()+"'",param);
        }
        ...
        try{
            if(TCari.getText().trim().equals("")){
                ps=koneksi.prepareStatement(
                        ...
                        "from reg_periksa inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "+
                        "inner join pengkajian_medis_ranap_penyakit_dalam on reg_periksa.no_rawat=pengkajian_medis_ranap_penyakit_dalam.no_rawat "+
                        "inner join dokter on pengkajian_medis_ranap_penyakit_dalam.kd_dokter=dokter.kd_dokter where "+
                        "pengkajian_medis_ranap_penyakit_dalam.tanggal between ? and ? order by pengkajian_medis_ranap_penyakit_dalam.tanggal");
            }else{
                ps=koneksi.prepareStatement(
                        "select reg_periksa.no_rawat,pasien.no_rkm_medis,pasien.nm_pasien,if(pasien.jk='L','Laki-Laki','Perempuan') as jk,pasien.tgl_lahir,pengkajian_medis_ranap_penyakit_dalam.tanggal,"+
                        "pengkajian_medis_ranap_penyakit_dalam.kd_dokter,pengkajian_medis_ranap_penyakit_dalam.anamnesis,pengkajian_medis_ranap_penyakit_dalam.hubungan,pengkajian_medis_ranap_penyakit_dalam.keluhan_utama,"+
                        ...
                        "inner join pengkajian_medis_ranap_penyakit_dalam on reg_periksa.no_rawat=pengkajian_medis_ranap_penyakit_dalam.no_rawat "+
                        "inner join dokter on pengkajian_medis_ranap_penyakit_dalam.kd_dokter=dokter.kd_dokter where "+
                        "pengkajian_medis_ranap_penyakit_dalam.tanggal between ? and ? and (reg_periksa.no_rawat like ? or pasien.no_rkm_medis like ? or pasien.nm_pasien like ? or "+
                        "pengkajian_medis_ranap_penyakit_dalam.kd_dokter like ? or dokter.nm_dokter like ?) order by pengkajian_medis_ranap_penyakit_dalam.tanggal");
            }
