...
public final class RMPenilaianAwalMedisRanapPsikiatrik extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        TglAsuhan.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "30-09-2024 21:13:52" }));
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(TNoRM.getText().trim().equals("")){
            ...
            if(Sequel.menyimpantf("pengkajian_medis_ranap_psikiatrik","?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?","No.Rawat",45,new String[]{
            ...
            try{
                ...
                if(TCari.getText().trim().equals("")){
                    ps=koneksi.prepareStatement(
                            "select reg_periksa.no_rawat,pasien.no_rkm_medis,pasien.nm_pasien,if(pasien.jk='L','Laki-Laki','Perempuan') as jk,pasien.tgl_lahir,pengkajian_medis_ranap_psikiatrik.tanggal,"+
                            "pengkajian_medis_ranap_psikiatrik.kd_dokter,pengkajian_medis_ranap_psikiatrik.anamnesis,pengkajian_medis_ranap_psikiatrik.hubungan,pengkajian_medis_ranap_psikiatrik.keluhan_utama,pengkajian_medis_ranap_psikiatrik.rps,pengkajian_medis_ranap_psikiatrik.rpk,pengkajian_medis_ranap_psikiatrik.rpd,pengkajian_medis_ranap_psikiatrik.rpo,pengkajian_medis_ranap_psikiatrik.penampilan,"+
                            "pengkajian_medis_ranap_psikiatrik.pembicaraan,pengkajian_medis_ranap_psikiatrik.psikomotor,pengkajian_medis_ranap_psikiatrik.sikap,pengkajian_medis_ranap_psikiatrik.mood,"+
                            "pengkajian_medis_ranap_psikiatrik.fungsi_kognitif,pengkajian_medis_ranap_psikiatrik.gangguan_persepsi,pengkajian_medis_ranap_psikiatrik.proses_pikir,pengkajian_medis_ranap_psikiatrik.pengendalian_impuls,pengkajian_medis_ranap_psikiatrik.tilikan,pengkajian_medis_ranap_psikiatrik.rta,"+
                            "pengkajian_medis_ranap_psikiatrik.keadaan,pengkajian_medis_ranap_psikiatrik.gcs,pengkajian_medis_ranap_psikiatrik.kesadaran,pengkajian_medis_ranap_psikiatrik.td,pengkajian_medis_ranap_psikiatrik.nadi,pengkajian_medis_ranap_psikiatrik.rr,pengkajian_medis_ranap_psikiatrik.suhu,pengkajian_medis_ranap_psikiatrik.spo,pengkajian_medis_ranap_psikiatrik.bb,pengkajian_medis_ranap_psikiatrik.tb,"+
                            "pengkajian_medis_ranap_psikiatrik.kepala,pengkajian_medis_ranap_psikiatrik.gigi,pengkajian_medis_ranap_psikiatrik.tht,pengkajian_medis_ranap_psikiatrik.thoraks,pengkajian_medis_ranap_psikiatrik.abdomen,pengkajian_medis_ranap_psikiatrik.ekstremitas,pengkajian_medis_ranap_psikiatrik.genital,pengkajian_medis_ranap_psikiatrik.kulit,"+
                            "pengkajian_medis_ranap_psikiatrik.ket_fisik,pengkajian_medis_ranap_psikiatrik.alergi,pengkajian_medis_ranap_psikiatrik.penunjang,pengkajian_medis_ranap_psikiatrik.diagnosis,pengkajian_medis_ranap_psikiatrik.tata,pengkajian_medis_ranap_psikiatrik.konsulrujuk,dokter.nm_dokter "+
                            "from reg_periksa inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "+
                            "inner join pengkajian_medis_ranap_psikiatrik on reg_periksa.no_rawat=pengkajian_medis_ranap_psikiatrik.no_rawat "+
                            "inner join dokter on pengkajian_medis_ranap_psikiatrik.kd_dokter=dokter.kd_dokter where "+
                            "pengkajian_medis_ranap_psikiatrik.tanggal between ? and ? order by pengkajian_medis_ranap_psikiatrik.tanggal");
                }else{
                    ps=koneksi.prepareStatement(
                            "select reg_periksa.no_rawat,pasien.no_rkm_medis,pasien.nm_pasien,if(pasien.jk='L','Laki-Laki','Perempuan') as jk,pasien.tgl_lahir,pengkajian_medis_ranap_psikiatrik.tanggal,"+
                            "pengkajian_medis_ranap_psikiatrik.kd_dokter,pengkajian_medis_ranap_psikiatrik.anamnesis,pengkajian_medis_ranap_psikiatrik.hubungan,pengkajian_medis_ranap_psikiatrik.keluhan_utama,pengkajian_medis_ranap_psikiatrik.rps,pengkajian_medis_ranap_psikiatrik.rpk,pengkajian_medis_ranap_psikiatrik.rpd,pengkajian_medis_ranap_psikiatrik.rpo,pengkajian_medis_ranap_psikiatrik.penampilan,"+
                            ...
                            "inner join pengkajian_medis_ranap_psikiatrik on reg_periksa.no_rawat=pengkajian_medis_ranap_psikiatrik.no_rawat "+
                            "inner join dokter on pengkajian_medis_ranap_psikiatrik.kd_dokter=dokter.kd_dokter where "+
                            "pengkajian_medis_ranap_psikiatrik.tanggal between ? and ? and (reg_periksa.no_rawat like ? or pasien.no_rkm_medis like ? or pasien.nm_pasien like ? or "+
                            "pengkajian_medis_ranap_psikiatrik.kd_dokter like ? or dokter.nm_dokter like ?) order by pengkajian_medis_ranap_psikiatrik.tanggal");
                }
    ...
    private void MnPenilaianMedisActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnPenilaianMedisActionPerformed
        if(tbObat.getSelectedRow()>-1){
            ...
            Valid.MyReportqry("rptCetakPenilaianAwalMedisRanapPsikiatrik.jasper","report","::[ Laporan Penilaian Awal Medis Rawat Jalan Psikiatrik ]::",
                "select reg_periksa.no_rawat,pasien.no_rkm_medis,pasien.nm_pasien,if(pasien.jk='L','Laki-Laki','Perempuan') as jk,pasien.tgl_lahir,pengkajian_medis_ranap_psikiatrik.tanggal,"+
                "pengkajian_medis_ranap_psikiatrik.kd_dokter,pengkajian_medis_ranap_psikiatrik.anamnesis,pengkajian_medis_ranap_psikiatrik.hubungan,pengkajian_medis_ranap_psikiatrik.keluhan_utama,pengkajian_medis_ranap_psikiatrik.rps,pengkajian_medis_ranap_psikiatrik.rpk,pengkajian_medis_ranap_psikiatrik.rpd,pengkajian_medis_ranap_psikiatrik.rpo,pengkajian_medis_ranap_psikiatrik.penampilan,"+
                "pengkajian_medis_ranap_psikiatrik.pembicaraan,pengkajian_medis_ranap_psikiatrik.psikomotor,pengkajian_medis_ranap_psikiatrik.sikap,pengkajian_medis_ranap_psikiatrik.mood,"+
                "pengkajian_medis_ranap_psikiatrik.fungsi_kognitif,pengkajian_medis_ranap_psikiatrik.gangguan_persepsi,pengkajian_medis_ranap_psikiatrik.proses_pikir,pengkajian_medis_ranap_psikiatrik.pengendalian_impuls,pengkajian_medis_ranap_psikiatrik.tilikan,pengkajian_medis_ranap_psikiatrik.rta,"+
                ...
                "from reg_periksa inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "+
                "inner join pengkajian_medis_ranap_psikiatrik on reg_periksa.no_rawat=pengkajian_medis_ranap_psikiatrik.no_rawat "+
                "inner join dokter on pengkajian_medis_ranap_psikiatrik.kd_dokter=dokter.kd_dokter where pengkajian_medis_ranap_psikiatrik.no_rawat='"+tbObat.getValueAt(tbObat.getSelectedRow(),0).toString()+"'",param);
        }
