...
public class DlgCariLoinc extends javax.swing.JDialog {
    ...
    public DlgCariLoinc(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgCariLoinc dialog = new DlgCariLoinc(new javax.swing.JFrame(), true);
                ...
                if(cmbHlm.getSelectedItem().toString().equals("Semua")){
                    if(TCari.getText().trim().equals("")){
                        ps = koneksi.prepareStatement(
                            ...
                            "select * from master_loinc order by master_loinc.display asc");
                        ...
                        ps = koneksi.prepareStatement(
                            ...
                            "select * from master_loinc where master_loinc.display like ? order by master_loinc.display asc");
                    }
                }
                else{
                    if(TCari.getText().trim().equals("")){
                        ps=koneksi.prepareStatement("select * from master_loinc order by master_loinc.display asc limit " +cmbHlm.getSelectedItem().toString() + " ");
                    }
                    else{
                        ps = koneksi.prepareStatement("select * from master_loinc where master_loinc.display like ? order by master_loinc.display asc limit " +cmbHlm.getSelectedItem().toString() + " ");
                    }
                }
