...
public class DlgCariSnomed extends javax.swing.JDialog {
    ...
    public DlgCariSnomed(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Data Cari Snomed-CT]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 50, 50))); // NOI18N
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgCariSnomed dialog = new DlgCariSnomed(new javax.swing.JFrame(), true);
            ...
            try {
                if(cmbHlm.getSelectedItem().toString().equals("Semua")){
                    if(TCari.getText().trim().equals("")){
                        ...
                        ps = koneksi.prepareStatement(
                            //"select * from master_snomed_ct where master_snomed_ct.display like ? order by master_snomed_ct.display asc limit " +cmbHlm.getSelectedItem().toString() + " ");
                            "select * from master_snomed_ct where master_snomed_ct.display like ? order by master_snomed_ct.display asc");
                    }
                }
                else{
                    if(TCari.getText().trim().equals("")){
                        ps=koneksi.prepareStatement("select * from master_snomed_ct order by master_snomed_ct.display asc limit " +cmbHlm.getSelectedItem().toString() + " ");
                    }
                    else{
                        ps = koneksi.prepareStatement("select * from master_snomed_ct where master_snomed_ct.display like ? order by master_snomed_ct.display asc limit " +cmbHlm.getSelectedItem().toString() + " ");
                    }
                }
