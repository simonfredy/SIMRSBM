...
public final class DlgRawatInap extends javax.swing.JDialog {
    ...
    public DlgRawatInap(java.awt.Frame parent, boolean modal) {
        ...
        tabModePemeriksaanSbar=new DefaultTableModel(null,new Object[]{
            ...
            "Situation","Background","Assesment","Recommendation","NIP","Dokter/Paramedis","Profesi/Jabatan","Status Verifikasi"}){
             @Override public boolean isCellEditable(int rowIndex, int colIndex){
                boolean a = false;
                if (colIndex==0) {
                    a=true;
        ...
        switch (TabRawat.getSelectedIndex()) {
            ...
            case 3:
                if(tabModePemeriksaan.getRowCount()==0){
                    ...
                    Valid.MyReportqry("rptInapPemeriksaan.jasper","report","::[ Lembar CPPT Pasien Rawat Inap ]::",
                            "select pemeriksaan_ranap.no_rawat,reg_periksa.no_rkm_medis,pasien.nm_pasien,pasien.no_ktp,DATE_FORMAT(pasien.tgl_lahir,'%d-%m-%Y') as tgl_lahir,pasien.jk,"+
...
private void BtnEditKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnEditKeyPressed
    ...
    */
    ...
    private widget.Button BtnVerifSbar,BtnVerifSbar3,BtnVerifikasiSOAP,BtnStatusVerifikasiSOAP,BtnGrafikTTV,BtnSeekPegawai1;
    ...
    private widget.TextArea TSituation,TBackground,TAssesment,TRecommendation;
    private widget.Label jLabel70,jLabel84,jLabel86,jLabel88,jLabel89,jLabel90,jLabel91,jLabel92,jLabel93;
    private widget.TextBox KdPeg2,KdPeg3,TPegawai2,TPegawai3,Jabatan1;
    ...
    private void tampilPemeriksaanSbar() {
        ...
        try{  
            ps7=koneksi.prepareStatement("select pemeriksaan_ranap_sbar.no_rawat,reg_periksa.no_rkm_medis,pasien.nm_pasien,"+
                ...
                "pemeriksaan_ranap_sbar.assesment,pemeriksaan_ranap_sbar.recommendation,pemeriksaan_ranap_sbar.nip,pegawai.nama,pegawai.jbtn, IF(vps.no_rawat IS NOT NULL, 'Tervalidasi', 'Belum Divalidasi')" +
                "from pasien inner join reg_periksa on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "+
    ...
    private void BtnVerifSbar3ActionPerformed(java.awt.event.ActionEvent evt) {                                              
        if(TPasien.getText().trim().equals("")||TNoRw.getText().trim().equals("")){
            JOptionPane.showMessageDialog(null,"Maaf, Silahkan anda pilih dulu dengan menklik data pada table...!!!");
            TCari.requestFocus();
        }else{
    ...
    private void jLabel84MouseClicked(java.awt.event.MouseEvent evt) {                                      
        if(TNoRw.getText().trim().equals("") ){
            JOptionPane.showMessageDialog(null,"Maaf, Silahkan anda pilih dulu dengan menklik data pada table...!!!");
            TCari.requestFocus();
        }else{
    ...
    private void jLabel86MouseClicked(java.awt.event.MouseEvent evt) {                                      
        if(TPasien.getText().trim().equals("")||TNoRw.getText().trim().equals("")){
            JOptionPane.showMessageDialog(null,"Maaf, Silahkan anda pilih dulu dengan menklik data pada table...!!!");
            TCari.requestFocus();
        }else{
